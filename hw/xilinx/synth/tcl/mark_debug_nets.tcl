...
#set_property MARK_DEBUG 1 [get_nets peripheral_bus_u/s_axi_arvalid*]
#set_property MARK_DEBUG 1 [get_nets peripheral_bus_u/s_axi_araddr*]
#set_property MARK_DEBUG 1 [get_nets peripheral_bus_u/s_axi_arsize*]
#set_property MARK_DEBUG 1 [get_nets peripheral_bus_u/s_axi_arready*]

#set_property MARK_DEBUG 1 [get_nets custom_rv_plic_u/irq_o*]
#set_property MARK_DEBUG 1 [get_nets peripheral_bus_u/int_o*]
