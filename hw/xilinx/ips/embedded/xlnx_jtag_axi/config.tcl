...
set_property CONFIG.M_AXI_DATA_WIDTH  $::env(AXI_DATA_WIDTH)  [get_ips $::env(IP_NAME)]
set_property CONFIG.M_AXI_ADDR_WIDTH  $::env(AXI_ADDR_WIDTH)  [get_ips $::env(IP_NAME)]
set_property CONFIG.M_AXI_ID_WIDTH    $::env(AXI_ID_WIDTH)    [get_ips $::env(IP_NAME)]
