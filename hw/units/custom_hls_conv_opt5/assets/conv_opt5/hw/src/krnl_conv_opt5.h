#ifndef __CONV_OPT5_H__
#define __CONV_OPT5_H__

#include <stdint.h> // uintN_t
#include "ap_int.h" // ap_uint
...
#ifdef MOCK_AP_INT
// Use uint8_t as minimal possible bitwidth
typedef uint8_t target_type_t;
// Make for 4 bits
#define AP_INT_MASK 0xf
#else
typedef ap_uint<7> target_type_t;
#endif
