...
# DRIVER_SOURCE_DIR=${CLONE_DIR}/hw/${COMPONENT_NAME}/hls/impl/ip/drivers/krnl_${COMPONENT_NAME}_v1_1/src

# C Headers
cp ${DRIVER_SOURCE_DIR}/xkrnl_${COMPONENT_NAME}.h ${TARGET_SW_DIR}/inc/
# C sources
...
# cp ${CLONE_DIR}/sw/src/host.c ${TARGET_SW_DIR}/src/
