...
GIT_URL=https://github.com/pulp-platform/cva6.git
GIT_TAG=pulp-v2.0.0-alpha.1
CLONE_DIR=cva6
CONFIG_TARGET=cv64a6_imafdch_sv39_wb
...
for rtl_file in $(cat assets/flist) ; do
    printf "\t${YELLOW}cloning $rtl_file${NC}\n"
    cp $rtl_file ${RTL_DIR}
done;
