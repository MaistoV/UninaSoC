...
//  Version opt3: double-buffering.

// Headers
#include <stdio.h>  // For printf()
#include <assert.h> // For assert()
#include "krnl_conv_opt3.h"
...
void krnl_conv_opt3 (
    ...
    #pragma HLS INTERFACE mode=m_axi depth=SIZE_W bundle=gmem1 port=W \
        max_read_burst_length=16 \
        max_widen_bitwidth=512 \
        max_write_burst_length=16

    #pragma HLS INTERFACE mode=m_axi depth=SIZE_O bundle=gmem2 port=O \
        max_read_burst_length=16 \
        max_widen_bitwidth=512 \
        max_write_burst_length=16 \
