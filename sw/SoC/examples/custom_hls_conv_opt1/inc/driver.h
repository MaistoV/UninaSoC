...
#define Xkrnl_Control          (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_AP_CTRL)
#define Xkrnl_GIE              (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_GIE)
#define Xkrnl_IER              (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_IER)
#define Xkrnl_ISR              (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_ISR)
#define Xkrnl_AXI_ADDR_I       (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_I_DATA)
#define Xkrnl_AXI_ADDR_W       (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_W_DATA)
#define Xkrnl_AXI_ADDR_O       (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_O_DATA)
#define Xkrnl_N                (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_N_INPUT_DATA)
#define Xkrnl_C                (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_C_INPUT_DATA)
#define Xkrnl_K                (Xkrnl_BASE + XKRNL_CONV_OPT1_CONTROL_ADDR_K_INPUT_DATA)
