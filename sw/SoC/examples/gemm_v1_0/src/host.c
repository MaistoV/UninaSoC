...
#define Xkrnl_BASE                  0x30000//__peripheral_HLS_Accelerator_Control_start
...
int check_results(uint32_t out[DATA_SIZE*DATA_SIZE]) {
...
int main() {
    ...
    else printf("ERROR! The result is not that expected");
